...
<script type="text/javascript">
	...
	function fn_addFile(){
	    ...
	    $("#d_file").append("<br>" + "<input type='file' style='background-color: #f5f5f6' id='file"+cnt+"' class='file_choice' name='file" + cnt + "'/>");
	...
	function fn_submit(){
		...
		if(fileFlag != null){
         ...
         var apply = confirm("프로필을 수정하시겠습니까?");
         if(apply == true){
            send_file();
	...
	function send_file(){
	       ...
	       var seq = $('input[name=chatProfileSeq]').val();
	          $.ajax({
	             type : 'post',
	             url : 'chatProfileModAjax.do',
	             data : formData,
	             processData : false,
	             contentType : false,
	             async:false,
	             ...
	             if(data=="ok"){
	                ...
	                location.href="chatDetail.do?chatProfileSeq=" + seq;
	             }else if(data=="no"){
                  ...
                  <form id="frm" class="appointment__form" method="post" 
							...
							<div class="col-lg-6 text-center mypage_myinfo"
                              ...
                              <div style="margin-bottom: 2px;">
                                 ...
                                 <br>
                                 <input type="hidden" name="chatProfileSeq" value="${chatProfile['chatProfileSeq']}">
								<p style="text-align: left;padding: 3px;"> <span style="background-color: #fff3bf;padding:5px;font-weight: bold;">현재 프로필 사진 : ${chatProfile['fileRealName']}</span></p>
                                 <div class="col-lg-12" style=" float: left; padding: 0; margin: 0;">
                                       <input type="button" class="file_add" value="파일 수정" onClick="fn_addFile()" style="float: left;margin-top: 10px;">
                                       <div id="d_file" style="text-align: left;float: left;background-color: #f5f5f6">
                           ...
                           <div class="col-lg-6 text-center mypage_myinfo"
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-lg-12 text-center">
                                    <textarea  
                                       id="trainerAward" name="simpleIntro" style="background-color: #3f51b50d; color: black; margin-bottom: 20px;resize: none;padding: 15px;" placeholder="간단 소개를 입력하세요">${chatProfile['chatProfileIntro']}
                                       </textarea>
                           ...
                           <div class="col-lg-6 text-center mypage_myinfo"
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-lg-12 text-center">
                                    <textarea  
                                       id="trainerAward" name="profileMemo" style="background-color: #3f51b50d; color: black; margin-bottom: 20px;resize: none;height: 200px;padding: 15px;" placeholder="프로필 메모를 입력하세요">${chatProfile['chatProfileMemo']}</textarea>

                                 </div>
                              </div>
                              <div class="col-lg-12" style="text-align: right;padding: 0">
                                      <input type="button" class="file_add" value="수정완료" style="width: 100%;font-size: 1.1em;" onclick="fn_submit()">
                                 </div>
                           </div>
